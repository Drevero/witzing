...
function linkeur($lien)
{
	...
	$lien=preg_replace('#(http|ftp|steam|https)://([A-Z0-9_-]+)(\.[a-z0-9]+){1,2}/?([A-Z0-9-/_\.\?=&;]+)([\.(png|PNG|jpg|jpeg|gif|GIF)]+)$#i', '<a href="javascript:;" onclick="lightbox(\'$0\', true);"><img src="$0" class="mini_img" title="$0"/></a>', $lien);
	return $lien;
}
function emoticons($texte)
{
	$liste_emoticons=Array('smile.png', 'sad.png', 'shock.png', 'embarrassed.png', 'good.png', 'laugh.png', 'love.png', 'mail.png', 'meeting.png', 'neutral.png', 'poop.png', 'present.png', 'quiet.png', 'rotfl.png', 'sick.png', 'sleepy.png', 'smile-big.png', 'sweat.png', 'tongue.png', 'victory.png', 'weep.png', 'wink.png', 'sun.png', 'question.png', 'bad.png');
	$texte_emo=Array(':\)', ':\(', ':O', ':X', '\(y\)', 'xD', '&lt;3', ':mail:', ':meeting:', ':/ ', ':caca:', ':cadeau:', ':chut:', 'x\'D', ':malade:', ':dormir:', ':D', '--\'', ':P', '\\\o/', ':\'\(', ';\)', ':soleil:', ':hein:', '\(n\)');
