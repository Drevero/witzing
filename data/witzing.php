...
function like_stats(id)
{
	...
	xhr.onreadystatechange = function() {
		if(xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0))
		{
			...
			if(ndom.getElementsByTagName('like')[0].getAttribute('me')=='1')
			{
	...
	xhr.open('GET', 'index.php?page=ajax&like_stats=' + id, true);
	xhr.send(null);
}
function unlike_stats(id)
{
	var xhr=new XMLHttpRequest();
	xhr.onreadystatechange = function() {
		if(xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0))
	...
	xhr.open('GET', 'index.php?page=ajax&notlike_stats=' + id, true);
	xhr.send(null);
}
function supr_post(id)
{
	var xhr=new XMLHttpRequest();
	xhr.onreadystatechange = function() {
		if(xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0))
